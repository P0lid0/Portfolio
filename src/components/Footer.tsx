  ...
  return (
    <footer>
      <div className="FooterContent" id="Contatos">
        <span>Pedro Henrique Polido Martins</span>
        <ul>
          <li>
        ...
        <ul>
          ...
          <li className="row">
            <p className="opacity">Telefone:</p><p>{"(11)"} 963161881</p>
          </li>
          <li className="row">
            <p className="opacity">Email:</p>
            <p>pedrinhopolido@gmail.com</p>
          </li>
        </ul>
        <ul>
          <li>
          ...
          <li>
            ...
            <a
              href="https://www.linkedin.com/in/pedro-p%C3%B3lido/"
              target="_blank"
            >
